...
const baseImageUrl = './assets/media_files' // this contains already downloaded images "20291 items"
const IMAGE_MAPPING_FILE = './logs/migrated_mediafiles.json' // Store the mapping
